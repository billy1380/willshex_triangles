      ...
      do {
        ...
        if (topPointLeft) {
          if (_palette is ImagePixelPalette) {
            ...
            if (_useGradient && _renderer is ImageRenderer) {
              _renderer.renderTriangle(_palette.randomColor, p1, p4, p2, true);
              _renderer.renderTriangle(_palette.randomColor, p2, p3, p4, true);
            } else {
          ...
          if (_palette is ImagePixelPalette) {
            ...
            if (_useGradient && _renderer is ImageRenderer) {
              _renderer.renderTriangle(_palette.randomColor, p1, p2, p3, true);
              _renderer.renderTriangle(_palette.randomColor, p1, p4, p3, true);
            } else {
